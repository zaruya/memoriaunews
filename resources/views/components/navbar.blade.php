      ...
      <div class="flex h-16 items-center justify-between">
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3" @click.away="openProfile = false">
              <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500" @click="openProfile = !openProfile" @click="openProfile = !openProfile"
  :class="{ 'ring-2 ring-indigo-500 ring-offset-2': openProfile }">
              ...
              <!-- Menu Dropdown yang akan muncul saat openProfile bernilai true -->
              <div 
                x-show="openProfile"
                ...
                class="absolute right-0 z-10 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg outline-1 outline-black/5 dark:bg-gray-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10 mt-2"
                style="display: none;"
              >
        ...
        <div class="-mr-2 flex md:hidden">
          <button type="button" @click="openMobile = !openMobile" class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-white/5 hover:text-white focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500">
            <span class="absolute -inset-0.5"></span>
            <span class="sr-only">Open main menu</span>
            
            <!-- Icon ketika menu tertutup (openMobile = false) -->
            <svg x-show="!openMobile" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6">
              <path d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            
            <!-- Icon ketika menu terbuka (openMobile = true) -->
            <svg x-show="openMobile" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6" style="display: none;">
    ...
    <!-- Konten Menu Mobile -->
    <div id="mobile-menu" x-show="openMobile" class="block md:hidden" style="display: none;">
